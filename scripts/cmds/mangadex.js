...
module.exports = {
  config: {
    ...
    longDescription: {
      vi: '',
      en: "Read Manga. this command source code by Gabriel De api is hosted by Abdul Kaiyum"
    },
    category: "anime",
    guide: {
      vi: '',
    ...
    try {
      ...
      if (type == "search") {
        ...
        if (Reply.searchStatus == true) {
          ...
          api.setMessageReaction('⏳', event.messageID, () => {}, true);
          const searchResult = await axios.get('https://consumet-api-s5m2.onrender.com/manga/mangadex/' + cleanSearch);
