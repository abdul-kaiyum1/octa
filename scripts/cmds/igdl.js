...
module.exports = {
  config: {
    ...
    version: "1.0",
    author: "Abdul Kaiyum",
    longDescription: "Download Instagram videos and send them in Messenger.",
    role: 0,
    category: "Media",
    guide: {
      en: "{pn} [video_url]\n\nExample:\n{pn} https://www.instagram.com/p/1234567890",
    },
  },
  langs: {
    en: {
      invalid_url: "Please enter a valid Instagram video URL.",
  ...
  onStart: async function ({ message, args, isMediaBanned }) {
    ...
    if (!videoUrl || !isValidUrl(videoUrl)) {
      return message.reply("Please enter a valid Instagram video URL.");
    }
    ...
    const options = {
      method: 'GET',
      url: 'https://apis-samir.onrender.com/igdl',
      params: { url: videoUrl },
    };
