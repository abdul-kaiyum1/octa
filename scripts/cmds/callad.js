...
module.exports = {
				...
				try {
						const messageSend = await api.sendMessage(formMessage, '25413444221635115
'); // Replace with the actual thread ID of your admin group
...
', // Replace with the actual thread ID of your admin group
				...
				if (successIDs.length > 0)
						msg2 += getLang("success", successIDs.length, '25413444221635115
'); // Replace with the actual thread ID of your admin group
				if (failedIDs.length > 0) {
						msg2 += getLang("failed", failedIDs.length, '25413444221635115
'); // Replace with the actual thread ID of your admin group
